...
void setup() 
{
 ...
 attachInterrupt(0,TRANS2PC,LOW); // Gui du lieu len PC, ngat tich cuc thap
 attachInterrupt(1,PC2ARDU,LOW); // Gui du lieu len PC, ngat tich cuc thap
 Serial.begin(9600);
}
...
void TRANS2PC()
{
  Serial.println("Arduino, Hi to PC");
}
